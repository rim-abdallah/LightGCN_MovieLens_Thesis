...
You define them here and pass them when running:

python LightGCN.py --epoch 100 --batch_size 512
'''
...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='Movie_Lens',
                        help='Choose a dataset from {Movie_Lens}')
